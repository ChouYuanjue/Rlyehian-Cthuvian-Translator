// Generated from the google-10000-english no-swears frequency list.
// Source: https://github.com/first20hours/google-10000-english
// These words are not used as visible RC-1 output. They only define a broad
// common-English seed set whose members receive deterministic RC-1 coined forms
// instead of long sealed fallback strings.
...
const STOP_WORDS = new Set([
  "the", "of", "and", "to", "a", "in", "for", "is", "on", "that", "by", "this", "with", "i", "you", "it", "not", "or", "be", "are", "from", "at", "as", "your", "an", "we", "will", "can", "us", "about", "if", "my", "has", "but", "our", "one", "do", "no", "they", "he", "she", "his", "her", "their", "them", "was", "were", "am", "been", "being", "there", "what", "which", "who", "when", "where", "why", "how", "than", "then", "so", "very", "also", "just"
]);
...
export function commonGeneratedTermFor(term) {
  ...
  if (!base || STOP_WORDS.has(base) || !COMMON_WORD_BASES.has(base)) return null;
  return {
    rc: coinedSurface(base),
    gloss: `common seed coined from ${base}`,
    source_base: base,
...
export function normalizeCommonBase(term) {
  ...
  for (const candidate of candidates) {
    if (COMMON_WORD_BASES.has(candidate)) return candidate;
  }
  return value;
}
